...
var app = (function() {
    ...
    _app.init   = function(){
        ...
        app.getUserInfo(function(){
            if(app.userInfo.has_img === 'Y') $(".profile-image").attr({src: base_url + "dbimagebyclient/E247/" + app.userInfo.company_id + "/" + userId }); 
            ...
            else $(".zsi-page-logo").attr({src: base_url + 'dbimage/ref-0010/client_id/' + app.userInfo.company_id + "/company_logo" }); 
        });
