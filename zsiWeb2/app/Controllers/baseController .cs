            ...
            if (d.page_id != 0)
                {
                    ...
                    ViewBag.layoutPage = string.Format("~/Views/Shared/{0}.cshtml", (isPublic == "Y" && d.master_page_name != "_PopUp" ? "_Public" : (d.master_page_name == null ? defaultPage : d.master_page_name)));
