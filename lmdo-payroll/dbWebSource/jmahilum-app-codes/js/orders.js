var orders =  (function(){
    ...
    zsi.ready = function(){  
        ...
        $('#po_issue_date input').datepicker({}); 
    ...
    function getTemplates(){
        ...
        .bsModalBox({
            ...
            , footer    :'<div class="pull-left"><button type="button" onclick="submitComment();" class="btn btn-primary"><i class="far fa-save"></i> Save</button></div>'
        })
        .bsModalBox({
              id        : gMdlShowComments
            , sizeAttr  : "modal-lg"
        ...
        .bsModalBox({
            ...
            , footer    :'<div class="pull-left"><button type="button" onclick="submitAttachment();" class="btn btn-primary"><i class="far fa-save"></i> Save</button></div>'
        })
        .bsModalBox({
              id        : gMdlDetails
            , sizeAttr  : "modal-full"
    ...
    $("#btnSaveOrders").click(function () {
        $("#tableOrder").jsonSubmit({
            ...
            ,onComplete: function (data) {
                ...
                var _customerId = _$tbl.find("#customer_id").val();
    ...
    function displayOrderParts(oId,oemId){ 
        ...
        _dataRows.push(
            ...
            ,{text:"Details"                ,width:200       ,style:"text-align:center"
                ,onRender: function(d){ return '<i class="fas fa-plus" aria-hidden="true" onclick="orders.showDetails('+ svn(d,"program_desc") +'\''+ svn(d,"order_part_id")+ '\')"></i>';} 
            }   
    ...
    function displayOrderPartsDetails(bRows,id){ 
        ...
        $("#orderPartDetailGrid").dataBind({
                 url                : app.procURL + "order_part_details_sel @order_part_id=" + "" 
                ,height             : $(window).height()
                ,width              : $("#frm_modalWindowOrderPartDetails").width() - 20 
                ,blankRowsLimit     : (bRows === "" ? 10 : bRows)
                ,dataRows           : [
                        {text: cb  ,width : 26   ,style : "text-align:left"
                        ...
                        ,{text:"Site"                          ,type:"select"          ,name:"site_id"                       ,width:300       ,style:"text-align:left"}
                ...
                ,onComplete: function(o){ 
                    this.find("[name='order_part_id']").dataBind({
                         sqlCode    : "O174"
                        ,text       : "part_desc"
                        ,value      : "order_part_id"
                    });
    ...
    $("#btnGo").click(function(){
        var bRows = $("#no_rows").val();
     
        displayOrderPartsDetails(bRows,$("#grid").data("id"));
    });
  ...
  /*  $(".form-grid").hide(); */
    ...
    $("#btnAddList").click(function(){ 
        ...
        $.post( app.procURL + "order_parts_ins "
            ...
            + ",@order_id='"            + gOrder_id + "'" 
            ,function(data){
            console.log("gOrder_id2",gOrder_id)    
            if(data.isSuccess===true) zsi.form.showAlert("alert");      
            var _$tbl = $("#tableOrder");
    ...
    $("#btnSaveOrderPartDetails").click(function () {
        $("#grid").jsonSubmit({
             procedure: "order_part_details_upd"
            ,optionalItems: ["is_active"] 
            ,onComplete: function (data) {
                displayOrderPartsDetails("",$("#grid").data("id")); 
            }
        });
    });
