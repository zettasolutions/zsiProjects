	   ...
	   // ,selectorType   : "checkbox"
        ...
        ,dataRows       : [
                            { text  : cb , width : 25   , style : "text-center" 
                                , onRender  :  function(d)
                                    { return     app.bs({name:"position_id" ,type:"hidden"  ,value: svn (d,"position_id")}) 
                                    +   app.bs({name:"is_edited"            ,type:"hidden"  ,value: svn (d,"is_edited")})  
                                    + (d !==null ? app.bs({name:"cb"        ,type:"checkbox"}) : "" ); }
                            }	 
            		        ,{text  : "Position Code"          , name  : "position_code"          , type  : "input"         , width : 200       , style : "text-align:left;"}
            		        ,{text  : "Position Name"          , name  : "position"               , type  : "input"         , width : 300       , style : "text-align:left;"}
