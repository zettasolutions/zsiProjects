    ...
    _pub.showModalContracts = function (eL,ctr,clientContractId,clientName,contractNo,clientId,contractDate,contractTermId,activationDate,expiryDate,planId,planQty,srpAmt,dpAmt) {
        ...
        function totalAmt(){
            setTimeout(function(){
               ...
               _$mdl.find("#total_amort_amount").val(commaSeparateNumber((_interest/100 * _productSrp) + _productSrp));
               _$mdl.find("#monthly_amort_amount").val(commaSeparateNumber((_interest/100 * _productSrp) + _productSrp/_noMos));
            },500);
        }
