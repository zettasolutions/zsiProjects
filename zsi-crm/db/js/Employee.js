        ...
        $("#grid").dataBind({
                ...
                ,dataRows   : [
        		    ...
        		    ,{text:"Info"                                       ,width:60         ,style:"text-align:center"
                        ,onRender : function(d){
                                var _link = "<a href='javascript:void(0)' ' title='View' onclick='employees.showModalViewId(this,"+ app.svn (d,"employee_id") +", \""+ app.svn (d,"first_name") +"\", \""+ app.svn (d,"middle_name") +"\",\""+ app.svn (d,"last_name") +"\",\""+ app.svn (d,"name_suffix") +"\",\""+ app.svn (d,"img_filename") +"\",\""+ app.svn (d,"position_id") +"\",\""+ app.svn (d,"emp_hash_key") +"\")'><i class='fas fa-eye'></i></a>";
                                return (d !== null ? _link : "");
                        }
                    }
