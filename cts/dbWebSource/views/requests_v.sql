...
AS
SELECT        dbo.requests.request_id, dbo.requests.request_no, dbo.requests.client_id, dbo.requests.app_id, dbo.requests.request_desc, dbo.requests.priority_level, 
