    ...
    function displayCustomerOrder(){   
        ...
        $("#gridCustomers").dataBind({
            ...
            ,dataRows   : [
        		...
        		,{ text:"Customer Name"    ,width: 355 ,style:"text-align:left;"     ,type:"input"   , name:"customer_name"}
         ...
         $("#gridInactiveCustomers").dataBind({
            ...
            ,dataRows       : [
                ...
                {text: cb  ,width : 25   ,style : "text-align:left;"
                    ,onRender  :  function(d)  
                        { return      bs({name:"customer_id"          ,type:"hidden"  ,value: svn(d,"customer_id")})
                                    + bs({name:"is_edited"            ,type:"hidden"  ,value: svn(d,"is_edited")})
        		...
        		,{ text: "Customer Code"   ,width: 300 ,style:"text-align:left;" 
        		     ,onRender : function(d){return bs({name:"customer_code"        ,value: svn(d,"customer_code")}) }
        		 }
        		,{ text:"Customer Name"    ,width: 355 ,style:"text-align:left;"     ,type:"input"   , name:"customer_name"}
        		,{text: "Active?"               ,name:"is_active"                ,type:"yesno"       ,width : 85    ,style : "text-align:center;"  ,defaultValue:"N"}
    	    ]
    	    ,onComplete: function(o){
