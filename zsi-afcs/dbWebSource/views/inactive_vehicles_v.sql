...
CREATE VIEW [dbo].[inactive_vehicles_v]
AS
SELECT        av.vehicle_id, av.company_id, av.vehicle_plate_no, av.conduction_no, av.chassis_no, av.engine_no, av.date_acquired, av.exp_registration_date, av.exp_insurance_date, av.vehicle_maker_id, av.odometer_reading, 
                         av.route_id, av.vehicle_type_id, av.is_active, av.status_id, av.hash_key, av.or_no, av.created_by, av.created_date, av.updated_by, av.updated_date, dbo.fare_matrix.vehicle_type, 
