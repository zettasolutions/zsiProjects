...
CREATE PROCEDURE [dbo].[afcs_legacy_logout_driver_upd]  
(  
...
BEGIN  
	...
	BEGIN
		...
		BEGIN
			...
			UPDATE dbo.devices SET driver_id = NULL WHERE 1 = 1 AND device_id = @device_id;

			-- Update the vehicles table and set the driver_id to NULL.
			UPDATE zsi_fmis.dbo.vehicles SET driver_id = NULL WHERE 1 = 1 AND hash_key = @vehicle_hash_key;

			SET @msg = 'The driver is logged out successfully.'
		END
