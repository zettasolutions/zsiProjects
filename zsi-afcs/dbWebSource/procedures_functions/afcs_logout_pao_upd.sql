...
CREATE PROCEDURE [dbo].[afcs_logout_pao_upd]  
(  
...
BEGIN  
	...
	BEGIN
		...
		BEGIN
			DECLARE @dt_out DATETIME = DATEADD(HOUR,@hour,GETUTCDATE());
			...
			UPDATE dbo.devices SET pao_id = NULL WHERE device_id = @device_id;
