...
SET @stmt = 'SELECT user_id, userFullName, logon, first_name, middle_name, last_name, name_suffix, password,  is_admin, role_id, is_developer, img_filename  FROM users_v WHERE is_active = ''' + CAST(@is_active AS VARCHAR(1)) + ''''
;  
