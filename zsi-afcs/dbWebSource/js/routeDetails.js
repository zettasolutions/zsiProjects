 var route = (function(){
    ...
    zsi.ready = function(){
        ...
        $("#route_id1").select2({placeholder: "ROUTE",allowClear: true});
            ...
            ,onComplete: function(o){
                ...
                _zRow.find("input[type='radio']").click(function(){
                    ...
                    $("#route_id1").dataBind({
                       ...
                       ,onChange     : function(){
                           var _val = $(this).val();
                           $("#route_id").val(_val).trigger("change");
                           $("#route_no").dataBind({
                                sqlCode      : "D1431"
                               ,parameters   : {route_id:_val}
                               ,text         : "route"
                               ,value        : "route_no"
                            });
                       }
    ...
    function displayRouteNos(id){
        ...
        $("#gridRouteNo").dataBind({
            ...
            ,dataRows       : [
                ...
                ,{text: "Route Name"                      ,name:"route_name"           ,type:"input"       ,width : 250    ,style : "text-align:left;"}
            ]
            ,onComplete: function(o){
                ...
                _zRow.find("input[type='radio']").click(function(){
    	            ...
    	            $("#route_no").dataBind({
                        sqlCode      : "D1431"
                       ,parameters   : {route_id:_routeId? _routeId :id}
                       ,text         : "route"
                       ,value        : "route_no"
                       ,onComplete   : function(){
                           $(this).val(_routeNo).trigger("change");
                       }
                    });
    	            displayRouteDetails(id,_routeNo);
    	            $(".page-title").html("Routes » " + _data.route_no + " » " + _data.route_name);
    ...
    $("#btnFilterVal").click(function(){
        ...
        $("#route_id1").val(gRouteId).trigger("change");
