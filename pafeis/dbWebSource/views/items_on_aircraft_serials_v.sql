...
SELECT        dbo.items.item_id, dbo.items.serial_no, dbo.items.manufacturer_id, dbo.getManufacturerName(dbo.items.manufacturer_id) AS manufacturer_name, dbo.items.dealer_id, dbo.getDealerName(dbo.items.dealer_id) 
                         ...
                         dbo.item_codes_v.national_stock_no, dbo.item_codes_v.item_code, dbo.item_codes_v.item_name, dbo.item_codes_v.item_type_name, dbo.item_codes_v.item_type_code, 
                         dbo.item_codes_v.monitoring_type_id, dbo.item_codes_v.unit_of_measure, dbo.item_codes_v.parent_item_type_id, dbo.item_codes_v.item_cat_code, dbo.item_codes_v.unit_of_measure_id, 
                         dbo.item_codes_v.critical_level, dbo.items.item_code_id
