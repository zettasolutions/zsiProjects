...
AS
SELECT        user_id, id_no, last_name, first_name, middle_name, logon, password, role_id, is_active, is_admin, contact_nos, img_filename, name_suffix, gender, organization_id, email_add, rank_id, civil_status, 
