...
SELECT        item_id, serial_no, manufacturer_id, manufacturer_name, dealer_id, dealer_name, supply_source_id, supply_source_name, time_since_new, time_before_overhaul, time_since_overhaul, remaining_time, date_delivered, 
                         aircraft_info_id, date_issued, status_id, part_no, national_stock_no, item_name, reorder_level, organization_id, item_cat_id, item_type_name, is_active, item_code_id, no_repairs, no_overhauls, item_inv_id, warehouse_id, 
