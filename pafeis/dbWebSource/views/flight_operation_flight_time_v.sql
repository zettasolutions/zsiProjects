...
SELECT        dbo.flight_operation.flight_operation_id, dbo.flight_operation.flight_operation_code, dbo.flight_operation.station_id, dbo.flight_operation.flight_schedule_date, dbo.flight_operation.unit_id, 
                         dbo.flight_operation.aircraft_id, dbo.getFlightPilots(dbo.flight_operation.flight_operation_id) AS pilots, dbo.flight_operation.ms_essential, dbo.flight_operation.itinerary, dbo.flight_operation.ms_category_id, 
                         ...
                         dbo.getStationById(dbo.flight_operation.station_id) AS station, dbo.getMissionSymbolById(dbo.flight_operation.ms_category_id) AS ms_category, dbo.getMissionSymbolById(dbo.flight_operation.ms_type_id) 
                         AS ms_type, dbo.getMissionSymbolById(dbo.flight_operation.ms_detail_id) AS ms_detail, dbo.getEngineStart(dbo.flight_operation.flight_operation_id) AS engine_start, 
                         dbo.getEngineStop(dbo.flight_operation.flight_operation_id) AS engine_stop, dbo.aircraft_info_v.aircraft_name, dbo.aircraft_info_v.squadron, dbo.aircraft_info_v.wing, dbo.aircraft_info_v.no_cycles AS total_cycles,
                          dbo.aircraft_info_v.squadron_id, dbo.aircraft_info_v.organization_id, dbo.aircraft_info_v.aircraft_type
