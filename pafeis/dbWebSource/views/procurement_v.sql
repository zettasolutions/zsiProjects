...
AS
SELECT        dbo.procurement.procurement_id, dbo.procurement.procurement_date, dbo.procurement.procurement_code, 
                        dbo.procurement.po_code, dbo.procurement.po_date, dbo.procurement.bac_code, dbo.procurement.bac_date, 
						dbo.procurement.procurement_name, dbo.procurement.supplier_id, dbo.procurement.organization_id,
						 ...
						 dbo.procurement.actual_delivery_date, dbo.procurement.procurement_type, dbo.procurement.procurement_mode, dbo.procurement.warehouse_id, dbo.getWarehouseLocation(dbo.procurement.warehouse_id) as warehouse,
