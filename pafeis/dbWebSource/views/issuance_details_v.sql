...
SELECT DISTINCT 
                         ...
                         dbo.issuance_details.serial_no, dbo.issuance_details.item_inv_id, dbo.issuance_details.item_status_id, dbo.getStatus(dbo.issuance_details.item_status_id) AS item_status
