...
SELECT        dbo.receiving.receiving_id, dbo.receiving.receiving_no, dbo.receiving.doc_no, dbo.receiving.doc_date, dbo.receiving.dealer_id, dbo.receiving.receiving_organization_id, dbo.receiving.transfer_organization_id, 
                         ...
                         dbo.getUserFullName(dbo.receiving.received_by) AS received_by_name, dbo.getStatusByPageProcessActionId(dbo.receiving.status_id) AS status_name, dbo.receiving_routings_current_v.process_desc, dbo.receiving.receiving_type
