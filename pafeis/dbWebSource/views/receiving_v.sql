...
SELECT        dbo.receiving.receiving_id, dbo.receiving.receiving_no, dbo.receiving.doc_no, dbo.receiving.doc_date, dbo.receiving.dealer_id, dbo.receiving.aircraft_id, dbo.receiving.received_by, dbo.receiving.received_date, 
                         dbo.receiving.status_remarks, dbo.receiving.created_by, dbo.receiving.created_date, dbo.receiving.updated_by, dbo.receiving.updated_date, dbo.receiving_routings_current_v.role_id, 
                         ...
                         dbo.getSupplySourceName(dbo.receiving.supply_source_id) AS supply_source
