...
SELECT        dbo.receiving_details.receiving_detail_id, dbo.receiving_details.receiving_id, dbo.receiving_details.item_code_id, dbo.receiving_details.serial_no, dbo.receiving_details.unit_of_measure_id, 
                         ...
                         dbo.receiving_routings_current_v.role_id, dbo.receiving.warehouse_id, dbo.item_codes_v.part_no, dbo.item_codes_v.national_stock_no, dbo.item_codes_v.item_name, dbo.item_codes_v.item_code, 
                         ...
                         dbo.receiving_details.procurement_detail_id, dbo.receiving.doc_date, dbo.receiving.procurement_id, dbo.receiving_details.manufacturer_id, dbo.item_codes_v.countSubCat
