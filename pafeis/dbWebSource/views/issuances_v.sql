...
SELECT        dbo.issuances.issuance_id, dbo.issuances.issuance_no, dbo.issuances.organization_id, dbo.issuances.issued_by, dbo.issuances.issued_date, dbo.issuances.issuance_directive_id, dbo.issuances.created_by,
                          dbo.issuances.created_date AS Expr8, dbo.issuances.updated_by AS Expr9, dbo.issuances.updated_date, dbo.issuances.aircraft_id, dbo.issuances.status_id, dbo.issuances.status_remarks, 
                         dbo.issuances.authority_ref, dbo.issuances.transfer_warehouse_id, dbo.countIssuanceDetails(dbo.issuances.issuance_id) AS countIssuanceDetails, dbo.issuance_routings_current_v.role_id, 
