...
SELECT        dbo.issuances.issuance_id, dbo.issuances.issuance_no, dbo.issuances.organization_id, dbo.issuances.issued_by, dbo.issuances.issued_date, dbo.issuances.issuance_directive_id, dbo.issuances.created_by,
                         ...
                         dbo.issuances.transfer_organization_id, dbo.countIssuanceDetails(dbo.issuances.issuance_id) AS countIssuanceDetails, dbo.issuance_routings_current_v.role_id, 
                         dbo.getOrganizationName(dbo.issuances.transfer_organization_id) AS transfer_organization_name, dbo.getAircraftName(dbo.issuances.aircraft_id) AS aircraft_name, 
                         dbo.getOrganizationName(dbo.issuances.organization_id) AS issuance_organization_name, dbo.getUserFullName(dbo.issuances.issued_by) AS issued_by_name, 
                         dbo.getStatusByPageProcessActionId(dbo.issuances.status_id) AS status_name
