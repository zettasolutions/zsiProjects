...
SELECT        dbo.item_codes.part_no, dbo.item_codes.national_stock_no, dbo.item_codes.item_name, dbo.item_codes.item_code_id, dbo.item_codes.item_code, dbo.item_codes.critical_level, dbo.item_codes.is_active, 
                         ...
                         dbo.item_codes.unit_of_measure_id, dbo.getItemTypeNameById(dbo.item_codes.item_type_id) AS item_type_name, dbo.item_categories.item_cat_name, dbo.item_categories.item_cat_code, dbo.item_categories.with_serial,
                         dbo.countSubCat(dbo.item_codes.item_cat_id) AS countSubCat, dbo.item_types.parent_item_type_id
