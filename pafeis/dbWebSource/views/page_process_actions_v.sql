...
SELECT        dbo.page_process_actions.page_process_action_id, dbo.page_process_actions.page_process_id, dbo.page_process_actions.seq_no, dbo.page_process_actions.action_desc, 
                         ...
                         dbo.page_process_roles.role_id, dbo.page_processes.is_default, dbo.page_process_actions.is_end_process, dbo.getStatus(dbo.page_process_actions.status_id) AS status_name
FROM            dbo.page_process_actions INNER JOIN
                         dbo.page_processes ON dbo.page_process_actions.page_process_id = dbo.page_processes.page_process_id LEFT OUTER JOIN
