...
var contextFlightOperation = { 
                ...
                , body  : '<div id="frm_modalFlightOperation" class="form-horizontal zContainer1" style="padding:5px">'
                        ...
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Operation Code</label>'
                        ...
                        +'        </div>' 
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Station</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'           <select name="station_id" id="station_id" class="form-control input-sm"><option value=""></option></select>'
                        +'         </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Flight Schedule</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        ...
                        +'    </div>'
                        +'    <div class="form-group">'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">No. of Cycle</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="no_cycles" id="no_cycles" class="form-control input-sm numeric">'
                        +'        </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Category</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <select name="ms_category_id" id="ms_category_id" class="form-control input-sm"><option value=""></option></select>'
                        +'        </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Type</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <select name="ms_type_id" id="ms_type_id" class="form-control input-sm"><option value=""></option></select>'
                        +'        </div>'
                        +'    </div>'
                        +'    <div class="form-group"> ' 
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Detail</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'           <select name="ms_detail_id" id="ms_detail_id" class="form-control input-sm"><option value=""></option></select>'
                        +'         </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Mission Essential</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'           <input type="text" name="ms_essential" id="ms_essential" class="form-control input-sm">'
                        +'         </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Itinerary</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'           <input type="text" name="itinerary" id="itinerary" class="form-control input-sm">'
                        +'         </div>'
                        +'    </div>'
                        +'    <div class="form-group">'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">FLT Condition </label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="flt_cond" id="flt_cond" class="form-control input-sm">'
                        +'        </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Sort</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="sort" id="sort" class="form-control input-sm numeric">'
                        +'        </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">PAX MIL </label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="pax_mil" id="pax_mil" class="form-control input-sm numeric">'
                        +'        </div>'
                        +'    </div>'
                        +'    <div class="form-group">'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">PAX CIV</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="pax_civ" id="pax_civ" class="form-control input-sm numeric">'
                        +'        </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">FNT MIL </label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="fnt_mil" id="fnt_mil" class="form-control input-sm numeric">'
                        +'        </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">FNT CIV</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="fnt_civ" id="fnt_civ" class="form-control input-sm numeric">'
                        +'        </div>'
                        +'    </div>'
                        +'    <div class="form-group">'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Cargo(lbs) </label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="cargo" id="cargo" class="form-control input-sm numeric">'
                        +'        </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Gas-up Location</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="gas_up_loc" id="gas_up_loc" class="form-control input-sm ">'
                        +'        </div>'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Gas-up(Ltr)</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        +'             <input type="text" name="gas_up" id="gas_up" class="form-control input-sm">'
                        +'        </div>'
                        +'    </div>'
                        +'    <div class="form-group">'
                        +'        <label class="col-xs-3 col-sm-2 col-md-2 col-lg-2 control-label">Gas-up Balance(Ltr)</label>'
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2">'
                        ...
                        +'        <div class="col-xs-9 col-sm-2 col-md-2 col-lg-2"><label class="col-xs-12 control-label" id="status_name" style="text-align:left !important"></label>'
                        +'             <input type="hidden" name="status_id" id="status_id" class="form-control input-sm">'
                        +'        </div>'
                        +'    </div>'
                        +'    <div class="form-group">'
                        +'        <label class="col-xs-3 col-sm-6 col-md-6 col-lg-6 control-label">Remarks</label>'
