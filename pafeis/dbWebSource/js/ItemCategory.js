...
function displayRecords(){
     $("#grid").dataBind({
        ...
        ,isPaging : false
        ,dataRows : [
        		 {text  : "Code"                , name  : "item_cat_code"                                     , width : 65        , style : "text-align:left;"
        		    , onRender      :  function(d){ 
                		                    return     bs({name:"item_cat_id",type:"hidden",value: svn (d,"item_cat_id")})
                		                           +   bs({name:"item_cat_code",value: svn (d,"item_cat_code")});
                            }        		    
        		}
