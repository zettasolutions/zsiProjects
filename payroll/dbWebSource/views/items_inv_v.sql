...
SELECT        dbo.item_codes_v.part_no, dbo.item_codes_v.national_stock_no, dbo.item_codes_v.item_name, dbo.item_codes_v.reorder_level, dbo.item_codes_v.is_active, dbo.items_inv.item_inv_id, dbo.items_inv.warehouse_id, 
                         ...
                         dbo.item_codes_v.item_cat_code, dbo.item_codes_v.unit_of_measure, dbo.item_codes_v.with_serial, dbo.getItemStatusQty(dbo.items_inv.item_inv_id, 23) AS stock_qty, dbo.getItemStatusQty(dbo.items_inv.item_inv_id, 24) 
                         AS for_repair, dbo.getItemStatusQty(dbo.items_inv.item_inv_id, 60) AS beyond_repair, dbo.getWingId(dbo.warehouses_v.squadron_id) wing_id
