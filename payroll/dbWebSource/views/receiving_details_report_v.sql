CREATE VIEW dbo.receiving_details_report_v
AS
SELECT        dbo.receiving_details.receiving_detail_id, dbo.receiving_details.receiving_id, dbo.receiving_details.item_code_id, dbo.receiving_details.serial_no, dbo.receiving_details.unit_of_measure_id, 
                         ...
                         dbo.receiving_details.manufacturer_id, dbo.receiving_details.status_id, dbo.item_codes_v.unit_of_measure, dbo.item_codes_v.with_serial, dbo.getStatus(dbo.receiving_details.status_id) AS item_status, 
                         dbo.getManufacturerName(dbo.receiving_details.manufacturer_id) AS manufacturer_name, dbo.getItemClass(dbo.receiving_details.item_class_id) AS item_class
